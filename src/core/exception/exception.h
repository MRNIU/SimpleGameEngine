...
#ifndef SIMPLEGAMEENGINE_SRC_CORE_INCLUDE_EXCEPTION_EXCEPTION_HPP
#define SIMPLEGAMEENGINE_SRC_CORE_INCLUDE_EXCEPTION_EXCEPTION_HPP
...
#endif /* SIMPLEGAMEENGINE_SRC_CORE_INCLUDE_EXCEPTION_EXCEPTION_HPP */
