...
#ifndef SIMPLEGAMEENGINE_SRC_PLATFORM_RHI_RHI_STRUCT_H
#define SIMPLEGAMEENGINE_SRC_PLATFORM_RHI_RHI_STRUCT_H
...
#endif  // SIMPLEGAMEENGINE_SRC_PLATFORM_RHI_RHI_STRUCT_H
