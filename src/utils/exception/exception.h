...
#ifndef SIMPLEGAMEENGINE_SRC_UTILS_EXCEPTION_EXCEPTION_HPP
#define SIMPLEGAMEENGINE_SRC_UTILS_EXCEPTION_EXCEPTION_HPP
...
#endif /* SIMPLEGAMEENGINE_SRC_UTILS_EXCEPTION_EXCEPTION_HPP */
