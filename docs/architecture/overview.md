...
| `editor` | egui shell、显式 `project.sge.ron` New/Open Project workflow、project-scoped scene file workflow、OBJ import、Assets UI、session imported mesh cache、Undo/Redo、viewport camera 和 transform gizmo |
