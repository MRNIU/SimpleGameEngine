...
- Linux/Xvfb 下 Editor authoring、Play input、WGPU callback、WGPU/CPU 实时切换、scene 不变断言，以及两种 Player backend 的 surface present/readback；性能采样另有确定性rolling-window/percentile/跳帧语义测试和真实Player双帧报告证据。
